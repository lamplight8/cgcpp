...
MyGLCanvas::MyGLCanvas(wxWindow* parent, const wxGLAttributes& canvasAttrs)
...
void MyGLCanvas::OnPaint(wxPaintEvent& event)
{
    ...
    glFrustum( -zNear * tanf( rFov / 2.0 ) * GLfloat(w)/h,
              zNear * tanf( rFov / 2.0 ) * GLfloat(w)/h,
              -zNear * tanf( rFov / 2.0 ),
              zNear * tanf( rFov / 2.0 ),
              zNear, zFar );
